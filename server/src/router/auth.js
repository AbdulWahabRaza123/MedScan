    ...
    if (patientData && radiologistEmail && !radiologistExist) {
      ...
      if (data) {
        ...
        var mailOptions = {
          ...
          text: "Your Report is Succesfully Generated by Radiologist. Go and check out!",
        };
        transporter.sendMail(mailOptions, function (error, info) {
          if (error) {
            console.log(error);
        ...
        (err, result) => {
          if (err) {
            ...
            var mailOptions = {
              ...
              text: "Your Report is Succesfully Updated by Radiologist. Go and check out!",
            };
            transporter.sendMail(mailOptions, function (error, info) {
              if (error) {
                console.log(error);
      ...
      Report.findOneAndUpdate(
        ...
        (err, updatedReport) => {
          if (err) {
            ...
            res.status(200).json({ message: "done", report: updatedReport });
          }
        }
      );
    } else {
